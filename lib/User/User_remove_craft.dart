...
class User_remove_craft_item extends StatefulWidget {
  @override
  _User_remove_craft_itemState createState() => _User_remove_craft_itemState();
}

class _User_remove_craft_itemState extends State<User_remove_craft_item> {
//Applying get request.
  ...
  Widget build(BuildContext context) {
    ...
    Future<void> delrecord(String id) async {
      String url =
          "http://$ip_address/charity_hope/user/user_craft_delete.php";
      ...
      if (resoponse["success"] == "true") {
        setState(() {
          Navigator.pushReplacement(
              context,
              MaterialPageRoute(
                  builder: (context) =>User_remove_craft_item()));
