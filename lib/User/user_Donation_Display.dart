...
class User_donation_Display_Page extends StatefulWidget {
  @override
  _User_donation_Display_PageState createState() => _User_donation_Display_PageState();
}

class _User_donation_Display_PageState extends State<User_donation_Display_Page> {
//Applying get request.

  Future<List<Donation_model>> getRequest() async {
    //replace your restFull API here.
    String url = "http://$ip_address/charity_hope/user/user__money_donation_display.php";
