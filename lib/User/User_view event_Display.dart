...
class User_view_event_Display_Page extends StatefulWidget {
  @override
  _User_view_event_Display_PageState createState() => _User_view_event_Display_PageState();
}

class _User_view_event_Display_PageState extends State<User_view_event_Display_Page> {
//Applying get request.

  Future<List<Event_model>> getRequest() async {
    //replace your restFull API here.
    String url = "http://$ip_address/charity_hope/user/user_view_event_display_data.php";
      ...
      if (resoponse["success"] == "true") {
        setState(() {
          Navigator.pushReplacement(
              context,
              MaterialPageRoute(
                  builder: (context) => User_view_event_Display_Page()));
