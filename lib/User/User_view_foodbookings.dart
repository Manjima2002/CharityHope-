...
class User_view_food_booking extends StatefulWidget {
  @override
  _User_view_food_bookingState createState() => _User_view_food_bookingState();
}

class _User_view_food_bookingState extends State<User_view_food_booking> {
//Applying get request.

  Future<List<Food_model>> getRequest() async {
    //replace your restFull API here.
    String url = "http://$ip_address/charity_hope/user/user_fooddonation_display_data.php";
